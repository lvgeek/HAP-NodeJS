...
Service.TemperatureSensor = function(displayName, subtype) {
  ...
  // Optional Characteristics
  this.addOptionalCharacteristic(Characteristic.Manufacturer);
  this.addOptionalCharacteristic(Characteristic.Model);
  this.addOptionalCharacteristic(Characteristic.SerialNumber);
  this.addOptionalCharacteristic(Characteristic.StatusActive);
  this.addOptionalCharacteristic(Characteristic.StatusFault);
  this.addOptionalCharacteristic(Characteristic.StatusLowBattery);
  this.addOptionalCharacteristic(Characteristic.StatusTampered);
